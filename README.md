...
[![Build Status](https://img.shields.io/github/workflow/status/tiredofit/docker-rspamd/build?style=flat-square)](https://github.com/tiredofit/docker-rspamd/actions?query=workflow%3Abuild)
...
### Prebuilt Images
Builds of the image are available on [Docker Hub](https://hub.docker.com/r/tiredofit/rspamd) and is the recommended method of installation.

```bash
docker pull tiredofit/rspamd:(imagetag)
```
